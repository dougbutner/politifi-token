...
namespace eosio {
    ...
    */
   class [[eosio::contract("halfhalf")]] halfhalf : public contract {
      public:
        ...
        const int64_t MAX_AMOUNT = eosio::asset::max_amount;
         ...
         using create_action = eosio::action_wrapper<"create"_n, &halfhalf::create>;
         using issue_action = eosio::action_wrapper<"issue"_n, &halfhalf::issue>;
         using retire_action = eosio::action_wrapper<"retire"_n, &halfhalf::retire>;
         using transfer_action = eosio::action_wrapper<"transfer"_n, &halfhalf::transfer>;
         using open_action = eosio::action_wrapper<"open"_n, &halfhalf::open>;
         using close_action = eosio::action_wrapper<"close"_n, &halfhalf::close>;
